...
# ================================================================
# run_CNRM-ESM2-1_pipeline.sh
#
# Description: Run CNRM-ESM2-1 NEMO Pipeline in current process.
#
...
# Define filepaths:
config_file=sst_si/config_CNRM_esm-piControl.toml
log_file=CNRM-ESM2-1_sst_si_pipeline.log
