"""
create_UKESM1-2_LL_NH_regional_masks.py

Description: Script to define SPNA, GIN and AO regional masks for UKESM1-2-LL.
...
outfilepath = "/g100_work/optim_IAC/research/noc/otooth/OptimESM/data/UKESM1-2-LL/Ofx/NH_regional_masks_Ofx_UKESM1-2-LL.nc"
