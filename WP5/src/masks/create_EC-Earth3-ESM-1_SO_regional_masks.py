"""
create_EC-Earth3-ESM1_SO_regional_masks.py
...
print("Completed: Created EC-Earth3-ESM-1 NEMODataTree.")
...
outfilepath = "/g100_work/optim_IAC/research/noc/otooth/OptimESM/data/EC-Earth3-ESM-1/Ofx/SO_regional_masks_Ofx_EC-Earth3-ESM1.nc"
