"""
create_UKESM1_World_Seas_IHO_v3_mask.py

Description:
Python script to create a 2-dimensional tracer variable labelling
T-grid points of the UKESM1 ocean model grid according to the IHO
...
def main(
    ...
    ds_domain = xr.open_dataset(domain_fpath)[['gphit', 'glamt']]
    ...
    glamt = ds_domain['glamt'].squeeze()
    gphit = ds_domain['gphit'].squeeze()
...
if __name__ == "__main__":
    ...
    # --- Configure Logging --- #
    logging.basicConfig(
        filename="UKESM1_World_Seas_IHO_masks.log",
        encoding="utf-8",
        filemode="a",
    ...
    # --- Run Main Function --- #
    main(
            domain_fpath="/g100/home/userexternal/otooth00/OptimESM/data/CINECA/MOHC/UKESM1_Ofx/domain_cfg_Ofx_UKESM1.nc",
        shp_fpath="/g100_work/optim_IAC/research/noc/otooth/OptimESM/IHO/World_Seas_IHO_v3/World_Seas_IHO_v3_combined.shp",
        out_fpath="/g100_work/optim_IAC/research/noc/otooth/OptimESM/IHO/masks/UKESM1-2_World_Seas_IHO_v3_mask.nc"
    )
