"""
create_IPSL_World_Seas_IHO_v3_mask.py

Description:
Python script to create a 2-dimensional tracer variable labelling
T-grid points of the IPSL ocean model grid according to the IHO
...
if __name__ == "__main__":
    ...
    # --- Configure Logging --- #
    logging.basicConfig(
        filename="IPSL-CM6-ESMCO2_World_Seas_IHO_masks.log",
        encoding="utf-8",
        filemode="a",
    ...
    # --- Run Main Function --- #
    main(
        domain_fpath="/g100/home/userexternal/otooth00/OptimESM/data/CINECA/IPSL/IPSL_Ofx/mesh_mask_Ofx_IPSL.nc",
        shp_fpath="/g100_work/optim_IAC/research/noc/otooth/OptimESM/IHO/World_Seas_IHO_v3/World_Seas_IHO_v3_combined.shp",
        out_fpath="/g100_work/optim_IAC/research/noc/otooth/OptimESM/IHO/masks/IPSL-CM6-ESMCO2_World_Seas_IHO_v3_mask.nc"
    )
